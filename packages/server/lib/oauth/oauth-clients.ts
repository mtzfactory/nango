...
export class NangoOAuth1Client {
    private client: oAuth1.OAuth;
    private integrationConfig: NangoIntegrationConfig;
    private authConfig: NangoIntegrationAuthConfigOAuth1;

    constructor(integrationConfig: NangoIntegrationConfig, callbackUrl: string) {
        this.integrationConfig = integrationConfig;

        this.authConfig = integrationConfig.auth as NangoIntegrationAuthConfigOAuth1;
...
export function getSimpleOAuth2ClientConfig(integrationConfig: NangoIntegrationConfig) {
    ...
    const authConfig = integrationConfig.auth as NangoIntegrationAuthConfigOAuth2;
