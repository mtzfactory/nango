...
// Test from the 'nango' folder root with command: npm run example syncGithubStargazers [owner] [repo] [any_user_id]
...
// Test from the 'nango' folder root with command: npm run example syncGithubUserRepos [api-key]
